...
public class IncomeServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request,
        ...
        if (amount == null || amount.isBlank()
            ...
            response.getWriter().println("<a href='income.jsp'>Go Back</a>");
            return;
        }
        ...
        try {
            ...
            String sql = "INSERT INTO income(amount, category, description, payment_mode, income_date) VALUES (?, ?, ?, ?, ?)";
            ...
            if (rowsInserted > 0) {
                ...
                out.println("<h2>Failed to Save Income!</h2>");

            }

            out.println("<br><br>");
            out.println("<a href='income.jsp'>Add Another Income</a>");
            out.println("<br><br>");
